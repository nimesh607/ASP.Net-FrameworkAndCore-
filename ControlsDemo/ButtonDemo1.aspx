...
<body>
    <form id="form1" runat="server">
        <div>
         ...
         <!--  Note: By default, Button control submits a page back to itself (Postback) only, and it is also capable of submitting the page to other pages also (Cross Page).
                Check the code in .cs file--> 
